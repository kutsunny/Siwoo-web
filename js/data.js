...
const LEVELS = [
  ...
  },
  {
    ...
    history:
      ...
      "특이한 점은 레이팅(별점·등급 부여) 과정입니다. 2023년 9월 9일 Zoink의 베리파이 이후에도 한동안 '미평가' " +
      "상태로 남아, 공식적으로는 데몬리스트 1위를 차지하지 못했습니다. 모더레이터 팀의 레이팅 찬성 투표가 모이지 " +
      "않으면서 최종 결정이 개발자 RobTop에게 넘어갔는데, RobTop은 한때 '게임플레이가 재미없고 Geometry Dash를 " +
      "잘 대표하지 못하며 논란이 많다'는 이유로 레이팅을 원하지 않는다고 밝히기도 했습니다.\n\n" +
      "그러나 수개월에 걸친 플레이어들의 요청 끝에, 결국 베리파이로부터 약 5개월이 지난 2024년 2월 18일 RobTop이 " +
      "레이팅을 부여했습니다. Tidal Wave는 Avernus를 제치고 데몬리스트 1위에 올라 '가장 어려운 정식 레이팅 레벨'이 " +
      "되었고, 이후 약 15개월간 1위를 지켜 역대 가장 오랫동안 연속으로 1위를 유지한 레벨로 기록됐습니다.\n\n" +
  ...
  },
  {
    ...
    history:
      ...
      "베리파이 경쟁 과정에서 가장 회자된 장면은 또 다른 도전자 totalgd의 82% 초크입니다. 베리파이를 코앞에 둔 " +
      "82% 지점에서 죽으며 사실상의 완주를 놓쳤고, 이 한 번의 실수는 USKC가 얼마나 잔혹한 레벨인지를 상징하는 " +
      "장면으로 커뮤니티에 깊이 남았습니다.\n\n" +
  ...
  },
  {
    ...
    history:
      ...
      "전반을 재작업하면서 지금의 새 Orochi(업커밍)로 이어졌습니다. 한편 너프 이전의 '원본 그대로의 옛 버전'은 " +
      "한동안 카피/유출 형태로만 플레이어들 사이를 돌며 도전 대상이 되어, '언너프드 올드 Orochi'로 일부 구간 기록이 " +
      "회자되곤 했습니다.\n\n" +
      "그리고 마침내, 원본 등장으로부터 약 9년 만에 미국의 플레이어 SeptaGon7(Volumni)이 이 언너프드 옛 Orochi를 " +
      "베리파이하며 '한때 불가능으로 여겨지던 원본'에 종지부를 찍었습니다. 리워크된 새 Orochi(업커밍)와는 별개의 " +
      "레벨로 구분됩니다.",
  },
  {
    id: "orochi",
    ...
    history:
      ...
      "손을 떼면서 Knobbelboy에게 넘어갔고, Knobbelboy가 난이도를 대폭 끌어올리고 Bloodlust에 비견되는 극악의 확장 " +
      "구간을 덧붙이며 '슈퍼 익스트림 데몬'급으로 재탄생시켰습니다. 확장 파트의 데코는 ZephiroX가 맡았습니다.\n\n" +
      "공개되면 곧바로 데몬리스트 1위를 차지할 것으로 기대를 모았지만, 정작 정식 공개·베리파이는 계속 미뤄졌습니다. " +
      "프리뷰만 수년 간격으로 띄엄띄엄 공개됐을 만큼(2019년, 2023년 등) 개발이 길어지며 '나올 듯 나오지 않는' 대표적인 " +
      "전설의 미공개작으로 회자됩니다.\n\n" +
      "2023년에는 Cdmusic, CuLuC, Iris 등이 합류해 Platnuu의 원본 절반가량을 다시 손보며 부활 움직임을 보였고, " +
      "베리파이어도 내정됐다고 알려졌습니다. 다만 이 페이지 기준으로 Orochi는 여전히 정식 공개·베리파이되지 않은 " +
      "상태로, '실제로 플레이할 수 있는 레벨'이라기보다 GD 역사에서 가장 오래 기다려진 미공개 전설로 남아 있습니다.",
  },
  {
    id: "silent-clubstep",
